...
#pandoc --pdf-engine=xelatex --toc --top-level-division=chapter -o knative-doc.pdf ${FILES[@]}
pandoc --pdf-engine=xelatex --toc --top-level-division=chapter -o knative-doc.pdf ${FILES[@]} && mv knative-doc.pdf /data0/download/
